...
func _ready() -> void:
	...
	DeveloperAuditLogger.log_ui(
		"Painel de ferramentas inicializado. F3/F4 ativos.",
		"PrototypeToolsPanel",
		{
			"tools_enabled": tools_enabled,
			"visible_on_start": visible_on_start,
			"allow_save_reset": allow_save_reset,
			"allow_force_result_actions": allow_force_result_actions
		}
	)
